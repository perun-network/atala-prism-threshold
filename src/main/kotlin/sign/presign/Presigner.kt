...
class Presigner (
    ...
    fun presignRound2(
        ...
        presignRound1Broadcasts: Map<Int, PresignRound1Broadcast>) : Map<Int, PresignRound2Broadcast> {
        ...
        for (j in signerIds) {
            if (j != id) {
                if (!presignRound2Input.verifyPresignRound1Broadcast(j, presignRound1Broadcasts[j]!!)) {
    ...
    fun processPresignOutput(
        signers : List<Int>,
        presignRound3Broadcasts: Map<Int, PresignRound3Broadcast>,
        elGamalPublics: Map<Int, ElGamalPublic>,
